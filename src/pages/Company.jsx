...
export default function Company() {
  return (
    <div className="text-white max-w-[1240px] mx-auto grid lg:grid px-4">
      <section className="bg-gray-100 py-16 px-4">
      <div className="max-w-4xl mx-auto px-2">

        <div className="text-center">
          <h2 className="bg-[#00df9a] font-semibold text-3xl">Features you'll love</h2>
          <p className="max-w-md mx-auto mt-2 text-gray-900">A responsive documentation template built for everyone who wants
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="text-gray-900 font-semibold text-xl">Customizable</h3>
              <p className="mt-1 text-gray-900"> You don't need to be an expert to customize this plugin. Our code is very
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="text-gray-900 font-semibold text-xl">Fully Responsive</h3>
              <p className="mt-1 text-gray-900"> With mobile, tablet &amp; desktop support it doesn't matter what device
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="text-gray-900 font-semibold text-xl">Developer Support</h3>
              <p className="mt-1 text-gray-900"> Our plugins are supported by sponsors who provide community support.
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="text-gray-900 font-semibold text-xl">Cross Browser</h3>
              <p className="mt-1 text-gray-900"> We make sure our plugins are working perfectly with all modern browsers
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="text-gray-900 font-semibold text-xl">Clean Code</h3>
              <p className="mt-1 text-gray-900"> We strictly follow a set of guidelines along with unit tests to make sure
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h3 className="text-gray-900 font-semibold text-xl">Well Maintained</h3>
              <p className="mt-1 text-gray-900"> This templatte is actively maintained by the core plugin team. We are
