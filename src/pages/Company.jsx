    ...
    <div className="text-white max-w-[1240px] mx-auto grid lg:grid px-4">
      ...
      <div class="max-w-4xl mx-auto px-2">
        ...
        <div class="text-center">
          <h2 class="bg-[#00df9a] font-semibold text-3xl">Features you'll love</h2>
          <p class="max-w-md mx-auto mt-2 text-gray-900">A responsive documentation template built for everyone who wants
        ...
        <div class="grid md:grid-cols-2 gap-10 mt-10">
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              <h3 class="text-gray-900 font-semibold text-xl">Customizable</h3>
              <p class="mt-1 text-gray-900"> You don't need to be an expert to customize this plugin. Our code is very
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              <h3 class="text-gray-900 font-semibold text-xl">Fully Responsive</h3>
              <p class="mt-1 text-gray-900"> With mobile, tablet &amp; desktop support it doesn't matter what device
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              <h3 class="text-gray-900 font-semibold text-xl">Developer Support</h3>
              <p class="mt-1 text-gray-900"> Our plugins are supported by sponsors who provide community support.
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              <h3 class="text-gray-900 font-semibold text-xl">Cross Browser</h3>
              <p class="mt-1 text-gray-900"> We make sure our plugins are working perfectly with all modern browsers
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              <h3 class="text-gray-900 font-semibold text-xl">Clean Code</h3>
              <p class="mt-1 text-gray-900"> We strictly follow a set of guidelines along with unit tests to make sure
          ...
          <div class="flex gap-4 items-start">
            ...
            <div>
              <h3 class="text-gray-900 font-semibold text-xl">Well Maintained</h3>
              <p class="mt-1 text-gray-900"> This templatte is actively maintained by the core plugin team. We are
